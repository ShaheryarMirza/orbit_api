...
def generate_zynk_sales_order_xml(orders: List[Order]) -> str:
    ...
    for order in orders:
        ...
        # Line discount percentage calculation for items
        ...
        # 6. Items mapping with line-level discounts
